...
-- 1.b Selecting first name and lastname from table
SELECT 
...
FROM
    actor
WHERE
    last_name LIKE ('%G%E%N%');

-- 2.c  Find all actors whose last names contain the letters LI. This time, order the rows by last name and first name, in that order:
SELECT 
